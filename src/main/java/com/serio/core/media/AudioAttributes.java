...
public class AudioAttributes implements Serializable {
	 ...
	 */
	@FfmpegOption(value="-acodec", type=OptionType.OUTPUT)
	 ...
	 */
	@FfmpegOption(value="-ab", type=OptionType.OUTPUT)
	 ...
	 */
	@FfmpegOption(value="-ar", type=OptionType.OUTPUT)
	 ...
	 */
	@FfmpegOption(value="-ac", type=OptionType.OUTPUT)
	 ...
	 */
	@FfmpegOption(value="-vol", type=OptionType.OUTPUT)
